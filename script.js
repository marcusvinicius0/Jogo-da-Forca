...
const categorias = {
    frutas: ["banana", "maça", "uva", "abacate", "mamao", "melancia", "melao", "laranja", "abacaxi", "pera"], //"açai", "acerola", "amora", "cacau", "carambola", "cereja", "coco", "figo", "framboesa", "goiaba", "groselha", "jabuticaba", "jaca", "kiwi", "limao", "manga", "maracuja", "morango", "pequi", "pessego"
    profissoes: ["advogado", "engenheiro", "medico", "professor", "pescador", "acougueiro", "programador", "dentista", "vendedor", "biologo"], //"lixeiro", "cozinheiro", "sushiman", "pedreiro", "eletricista", "padeiro", "confeiteiro", "policial", "militar", "politico", "piloto", "malabarista", "palhaço"
    animais: ["camelo", "vaca", "papagaio", "gaviao", "cavalo", "gato", "cervo", "gaivota", "rinoceronte", "abelha"],
    cores: ["rosa", "branco", "violeta", "amarelo", "marrom", "roxo", "lilas", "beje", "prata", "verde"],
}
